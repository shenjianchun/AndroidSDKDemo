 ...
 */
public class WindowSurface extends GraphicsActivity implements SurfaceHolder.Callback2 {
    ...
    protected void onResume() {
        ...
        synchronized (mDrawingThread) {
            mDrawingThread.mIsRunning = true;
    ...
    protected void onPause() {
        ...
        synchronized (mDrawingThread) {
            mDrawingThread.mIsRunning = false;
            mDrawingThread.notify();
        }
    }
    ...
    class DrawingThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                ...
                synchronized (this) {
                    while (mSurface == null || !mIsRunning) {
